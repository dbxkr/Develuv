...
//        List<String> addrs = new ArrayList<>();
        String[] addrs = {"서울서초구사임당로64","서울서초구서초중앙로12길38","서울서초구효령로403","서울강남구역삼로3길20-4",
        ...
        for (int i = 13; i < 32; i++) {
            ...
            matchingService.insertCoodr(addrs[i-13],"서울시",users.get(i).getUser_id());
        }
    ...
    public List<MatchingListDTO> kdtreetest(@RequestParam("city") String city,
        ...
        result = matchingService.findMatchingListByCity(city,user_id);
